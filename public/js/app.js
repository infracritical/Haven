...
import SocketMethods   from './modules/app-socket.js?v=2.7.5';
...
import ChannelMethods  from './modules/app-channels.js?v=2.7.5';
import MessageMethods  from './modules/app-messages.js?v=2.7.6';
import UserMethods     from './modules/app-users.js?v=2.7.0';
import VoiceMethods    from './modules/app-voice.js?v=2.7.0';
import UtilityMethods  from './modules/app-utilities.js?v=2.7.6';
import AdminMethods    from './modules/app-admin.js?v=2.7.0';
import PlatformMethods from './modules/app-platform.js?v=2.7.5';
